            ...
            <div className="bg-white-100 p-4 rounded-lg mb-12">
                ...
                <div className="flex flex-wrap">
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Mortgage</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Debt</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Loan Servicing</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Accured Interest</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Annual Percent Rate (APR)</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Asset</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Broker</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Co-Signer</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="w-1/3 p-2">
                        <h4 className="text-lg font-bold mb-2">Default</h4>
                        <div className="bg-white-100 p-4 rounded-lg">
                    ...
                    <div className="bg-white-100 p-4 rounded-lg mb-12 w-full">
                        ...
                        <div className="flex justify-center mb-4">
                            ...
                            <div className="flex-shrink-0 w-1/3 p-4 mr-4">
                                <h4 className="text-xl font-bold mb-2">What exactly is a mortgage?</h4>
                                {/* Video content */}
                            ...
                            {/* Second Video Box */}
                            <div className="flex-shrink-0 w-1/3 p-4 mr-4">
                                <h4 className="text-xl font-bold mb-2">Home Ownership Basics</h4>
                                {/* Video content */}
                                <div className="bg-white-200 h-64 rounded-lg border border-gray-300"></div>
                                <br />
                                <p className="text-gray-400">*how to invest or save on retirement*</p>
