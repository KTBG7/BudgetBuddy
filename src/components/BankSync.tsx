      ...
      <form className="w-full max-w-md mb-1" style={{ maxWidth: '40%' }}>
        ...
        <div className="mb-4">
          <p className="text-gray-400 text-center mb-8">
            BudgetBuddy takes your information seriously. All financial data is{' '}
            <br /> securely encrypted and transmitted via <em>Plaid</em>.
            Sensitive information, such <br /> as bank credentials, will be kept
            safe.
          </p>
        </div>
        ...
        <Link
          to="/sync"
          className="absolute top-16 left-4 mt-4 ml-4 text-blue-500 flex items-center"
        >
          <svg
