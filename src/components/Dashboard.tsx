        ...
        <div className="bg-gray-100 min-h-screen"> <br />
            ...
            <div className="ml-8 sm:ml-10">
                <Link to="/" className="block-flex mb-4 flex items-center">
                    ...
                    <h2 className="text-4xl font-bold mb-6 ml-auto mr-auto text-center" style={{ maxWidth: "max-content" }}>
                        Welcome, Jon 👋
                    </h2>
            ...
            <div className="flex flex-col mt-8 sm:flex-row rounded-lg pl-1">
                ...
                <div className="w-3/4 pl-4">
                    {/* Main Content Area */}
                    <div className="bg-gray-100 rounded-lg p-4" style={{ marginTop: '15rem' }}>
